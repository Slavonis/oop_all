...
xml_xslt_plugin_2::xml_xslt_plugin_2() : m_rootTagName("transport_list") {}


std::string xml_xslt_plugin_2::processBeforeSave(const nlohmann::json& jsonData) {
...
nlohmann::json xml_xslt_plugin_2::processAfterLoad(const std::string& xmlStr) {
